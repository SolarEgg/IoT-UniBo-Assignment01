...
void initCore() {
  Serial.begin(9600); // Start serial comunication (for debugging)
...
void intro() {
  ...
  // Non-blocking fade for the red LED --> no delay()
...
// DEEP_SLEEP state: Powers down the Arduino
void deep_sleep() {
